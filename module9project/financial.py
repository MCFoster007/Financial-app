...
def add_expense(self, category_name: str, amount: float, description: str,
    ...
    return self.categories[category_name].add_expense(amount, description,
                                                      date)
    ...
    try:
        with open("budget_data.json", "r") as f:
            try:
                ...
                print(
                    "Warning: Could not load data, File is corrupted or invalid."
                )
...
if choice == '1':
        # TO DO: Prompt for monthly income as input. Set income and display
        #what income is set to.
